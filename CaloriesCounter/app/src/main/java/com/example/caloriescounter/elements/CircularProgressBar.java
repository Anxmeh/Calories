package com.example.caloriescounter.elements;
...
public class CircularProgressBar extends View
{
    ...
    public CircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle)
    {
        ...
        try
        {
            ...
            @SuppressLint("ResourceAsColor") final int progressColor = args.getColor(R.styleable.circularProgressBar_progressColor, R.color.white);
